        ...
        <header class="page-header header container-fluid">
            ...
            <div class="description">
                ...
                <!-- <p>Lorem iue interdum quam odio, quis placerat ante luctus eu. 
                 ...
                 -->
                <a href="inlog.php" class="btn btn-outline-secondary btn-lg" role="button" >Click here to create your first Collection!</a> <!--THIS LINKS TO THE CREATE PAGE-->
<br><br>
                <a href="logout.php" class="btn btn-outline-secondary btn-lg" role="button" >Click here to Logout</a> <!--THIS LINKS TO THE CREATE PAGE-->
            </div> 
